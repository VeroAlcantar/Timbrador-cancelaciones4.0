...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="cfdi:Emisor">
		...
		<!--
			Llamadas para procesar al los sub nodos del emisor
		-->

		<xsl:if test="./cfdi:DomicilioFiscal">
			<xsl:call-template name="Domicilio">
				<xsl:with-param name="Nodo" select="./cfdi:DomicilioFiscal"/>
			</xsl:call-template>
		...
		<xsl:if test="./cfdi:RegimenFiscal">
